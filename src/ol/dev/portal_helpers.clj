...
(ns ^:clj-reload/no-reload ol.dev.portal-helpers
  "A collection of portal render/submit helpers for REPL driven development"
...
(try
  ...
  (catch Throwable _
    (throw (ex-info "Portal is not available, please add the dependency to your classpath."
                    {}))))

(try
  (require '[lambdaisland.ansi :as ansi])
  (catch Throwable _
    (throw (ex-info "lambdaisland.ansi is not available, please add the dependency to your classpath."
                    {}))))
